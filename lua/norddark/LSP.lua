local LSP = {
		...
		LspDiagnosticsVirtualTextHint = {fg = C.gray_blue, },
		...
		LspDiagnosticsFloatingHint = {fg = C.gray_blue, },
		...
		LspDiagnosticsUnderlineHint = {fg = C.gray_blue, },
